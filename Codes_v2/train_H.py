...
tf.compat.v1.summary.scalar(tensor=lp_loss, name='lp_loss')
tf.compat.v1.summary.scalar(tensor=mesh_loss, name='mesh_loss')
##  summary of input
tf.compat.v1.summary.image(tensor=train_depth, name='train_depth')
...
##  summary of output
tf.compat.v1.summary.image(tensor=train_warp2_depth, name='train_warp2_depth')
